...
- Rule-based connection handling for `headphones`, `direct_usb`, `guitar_amp_input`, `fx_return`, and `four_cable_method`; these rules control AMP/CAB enabled state.
...
- Verified effect batch 001 has been added; the profile now contains 47 manually verified GP-200 effect names and generated patches use verified effects when possible.
